        ...
        <v-row>
            <v-col cols="11" md="6">
                ...
                <div class="responsive-image-container ml-4">
                    <v-img src="@/assets/images/AboutUs.png" height="534" width="557" class="responsive-image"></v-img>
                </div>
            </v-col>
            <v-col cols="11" md="6">
            ...
            <v-col cols="6"  v-if="showAdditionalContent">
                <div class="card-container mt-5" style="color: white">
                    <div class="card d-flex flex-row">
                        <div class="pt-4 pl-4 pr-4 pb-4 ml-16">
            ...
            <v-col cols="6 mt-10"   v-if="showAdditionalContent">
            <p class="about-text-two mt-10">Personalized service with perfection is our mantra. We go <br>above and beyond to cater to your requirements and deliver   products and services that surpass your expectations. </p>
            </v-col>
            ...
            <v-col cols="12"   v-if="showAdditionalContent">
                <p class="in-touch-text ml-10">Lets get in <br> touch!</p>
                <p class="text-center about-text-two mt-5">Personalized service with perfection is our mantra. We go above and beyond to cater to <br> your requirements and deliver products and services that surpass your expectations. </p>
                <v-btn class="submit-button-one ml-10 mt-5 mb-15" @click="submitForm">
                    <div class="circle-text">
                        <p class="ml-3">CO</p>
                    </div>
